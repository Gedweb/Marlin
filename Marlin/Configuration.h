...
#define STRING_CONFIG_H_AUTHOR "(Gedweb, QQ-S config)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // FLSUN QQ-S autotune command M303 C8 S175
  #define DEFAULT_Kp 17.00
  #define DEFAULT_Ki 1.17
  #define DEFAULT_Kd 61.53
...
#define DELTA
  ...
  #define DELTA_HEIGHT 371.00             // (mm) Get this value from G33 auto calibrate
...
#define DEFAULT_XYZ_STEPS_PER_UNIT 320 // 20 touth
#define DEFAULT_AXIS_STEPS_PER_UNIT   { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, 1468 }  // default steps per unit
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 2000, 2000, 2000, 800 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 3, -2, -13 }  //OPT (Stock 16.2) (E3Dv6 -14.1)
